<template xmlns:v-data-dictionary-directive="http://www.w3.org/1999/xhtml">
  <div id="user-list">
    ...
    <user-create v-if="showAddPopover" v-on:closePopover="closePopover('create')"></user-create>
    <user-update v-if="showUpdatePopover" v-on:closePopover="closePopover('update')" v-bind:selectedModel="selectedModel"></user-update>
    <user-import  v-if="showImportPopover" v-on:closePopover="closePopover('import')"></user-import>
  </div>
</template>
<script>
import Vue from 'vue'
