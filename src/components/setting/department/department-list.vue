<template>
  <div id="department-list">
    ...
    <department-create v-if="showAddPopover" v-on:closePopover="closePopover('create')"></department-create>
    <department-update v-if="showUpdatePopover" v-on:closePopover="closePopover('update')" v-bind:selectedModel="selectedModel"></department-update>
  </div>
</template>
<script>
import Vue from 'vue'
