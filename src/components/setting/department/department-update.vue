        ...
        <div class="scroll-box">
          <form>
            ...
            <div class="row">
              ...
              <div class="form-group col-xs-6">
                <input type="text" class="form-control"  placeholder="部门名" v-model="updateModel.name">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-2 text-right">
              ...
              <div class="form-group col-xs-6">
                <input type="text" class="form-control" placeholder="父部门" v-model="updateModel.pname">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-2 text-right">
              ...
              <div class="form-group col-xs-6">
                <input type="text" class="form-control" placeholder="部门负责人" v-model="updateModel.leader">
              </div>
            </div>
            <div class="row">
              <div class="col-xs-2 text-right">
    ...
    methods:{
        ...
        doUpdate:function () {
            if(Vue.$isNullOrIsBlankOrIsUndefined(this.updateModel.name)){
              this.$message('warning','请输入部门名',3000);
              return;
            }
